...
Leaf also provides accompanying tools for authoring [Single File Components](../docs/single-file-component.html) (SFCs). If you want to use SFCs then you'll also need to install `@Leaf/compiler-sfc`:
...
In addition to `@Leaf/compiler-sfc`, you'll also need a suitable SFC loader or plugin for your chosen bundler. See the [SFC documentation](../docs/single-file-component.html) for more information.
