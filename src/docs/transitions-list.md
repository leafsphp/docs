...
- [Transition modes](/docs/transitions-enterleave.html#transition-modes) are not available, because we are no longer alternating between mutually exclusive elements.
