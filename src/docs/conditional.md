...
<VideoLesson href="https://Leafschool.io/lessons/conditional-rendering-in-Leaf-3?friend=leafphp" title="Learn how conditional rendering works with Leaf School">Learn how conditional rendering works with a free lesson on Leaf School</VideoLesson>
...
```html
<h1 v-if="awesome">Leaf is awesome!</h1>
```
