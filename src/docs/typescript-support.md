...
Or, if you want to combine TypeScript with a [JSX `render` function](/docs/render-function.html#jsx):
...
If you're using [single-file components](/docs/single-file-component.html) then this would typically be written as:
