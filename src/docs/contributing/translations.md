...
The first step is to check whether there is an existing translation for the relevant language. In addition to the table above, a good place to start is [this pinned issue](https://github.com/leafphp/docs/issues/478), which is used to keep track of the various translation initiatives happening in the community.
...
Once you start a translation, be sure to add it to [the pinned issue](https://github.com/leafphp/docs/issues/478) so that the rest of the community can find it.
