...
* [Props](/docs/component-basics.html#passing-data-to-child-components-with-props) and [events](/docs/component-basics.html#listening-to-child-components-events) should be your first choice for parent-child communication. Siblings can communicate via their parent.
* [Provide and inject](/docs/component-provide-inject.html) allow a component to communicate with its slot contents. This is useful for tightly-coupled components that are always used together.
...
* [Global state management](/docs/state-management.html), such as [Leafx](https://next.Leafx.leafphp.org/).
