...
Leaf also provides great support for both consuming and creating custom elements. For more details, check out the [Leaf and Web Components](/v3.x/docs/web-components.html) section.
