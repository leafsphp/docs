...
The webpack config for an SSR project will be similar to a client-only project. If you're not familiar with configuring webpack, you can find more information in the documentation for [Leaf CLI](https://cli.leafphp.org/v3.x/docs/webpack.html#working-with-webpack) or [configuring Leaf Loader manually](https://Leaf-loader.leafphp.org/v3.x/docs/#manual-setup).
