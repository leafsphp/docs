...
Support for the [inline-template feature](https://leafphp.org/v2/v3.x/docs/components-edge-cases.html#Inline-Templates) has been removed.
...
> - Note: In 3.x, slots can be rendered as the root with native [fragments](/v3.x/docs/migration/fragments) support!
