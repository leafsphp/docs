...
In Leaf 3, components now have official support for multi-root node components, i.e., fragments!
...
For more information on how attribute inheritance works, see [Non-Prop Attributes](/v3.x/docs/component-attrs.html).
