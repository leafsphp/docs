...
For more information on how `setup()` works, see our [Composition API Guide](/v3.x/docs/composition-api-introduction.html).
...
See [Render Function Guide](/v3.x/docs/render-function) for more detailed documentation!
