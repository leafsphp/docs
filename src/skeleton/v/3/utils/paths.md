# Skeleton Paths <sup class="new-tag-1">New</sup>

Paths define where Skeleton should look for items throughout the file system. Also these paths are available as methods you can call.
